      ...
      >
        <Box
          sx={{
            ...
            display: 'none', // @TODO: need to open again after finish system
        ...
        >
          <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ py: 2, pr: 1, pl: 2.5 }}>
            <Typography variant="subtitle1">{translate(`typo.settings`)}</Typography>
          ...
          <Scrollbar sx={{ height: 1 }}>
            <Stack spacing={4} sx={{ pt: 3, px: 3, pb: 15 }}>
              <Stack spacing={1.5}>
                <Typography variant="subtitle2">{translate(`typo.mode`)}</Typography>
                <SettingMode />
              </Stack>

              <Stack spacing={1.5}>
                <Typography variant="subtitle2">{translate(`typo.direction`)}</Typography>
                <SettingDirection />
              </Stack>

              <Stack spacing={1.5}>
                <Typography variant="subtitle2">{translate(`typo.color`)}</Typography>
                <SettingColor />
              </Stack>

              <Stack spacing={1.5}>
                <Typography variant="subtitle2">{translate(`typo.stretch`)}</Typography>
                <SettingStretch />
              </Stack>

        ...
        {hoverInfo && (
          ...
          >
            <Typography component="div" variant="caption">
              <strong>{translate(`typo.state`)}:</strong> {hoverInfo.feature.properties.name}
            </Typography>
            <Typography component="div" variant="caption">
              <strong> {translate(`typo.median_household_income`)}: </strong>
              {hoverInfo.feature.properties.value}
            </Typography>
            <Typography component="div" variant="caption">
              <strong>{translate(`typo.percentile`)}:</strong>
